...
void RenderingDeg90(int height, int size) //Отрисовка треугольника с поворотом в 90 градусов
{
...
void RenderingDeg0(int height, int size) //Отрисовка треугольника без поворота
{
